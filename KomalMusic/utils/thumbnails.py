...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("KomalMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("KomalMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("KomalMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("KomalMusic/assets/play_icons.png")
